...
describe('MemoryStore', () => {
  ...
  it('scanAll returns memories from both private and team scopes', async () => {
    ...
    await store.save({ name: 'Private', description: 'p', type: 'user', content: 'p', scope: 'private' })
    await store.save({ name: 'Team', description: 't', type: 'project', content: 't', scope: 'team' })
