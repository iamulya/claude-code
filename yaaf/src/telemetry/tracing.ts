...
export function isTracingEnabled(): boolean {
  const v =
    process.env.YAAF_OTEL_TRACES_EXPORTER ??
...
export function endLLMRequestSpan(
  ...
  if (isTracingEnabled()) {
    ...
    if (meta?.cacheReadTokens  !== undefined) endAttrs['llm.cache_read_tokens']  = meta.cacheReadTokens
    if (meta?.cacheWriteTokens !== undefined) endAttrs['llm.cache_write_tokens'] = meta.cacheWriteTokens
